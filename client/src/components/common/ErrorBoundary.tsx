...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(errorCaught: Error, errorInfo: React.ErrorInfo) {
    console.error('Error caught by boundary:', errorCaught, errorInfo)
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      console.error('Production error:', errorCaught.message)
    }
  }
...
export const AsyncErrorBoundary: React.FC<ErrorBoundaryProps> = ({ children, fallback }) => {
...
export const RouteErrorBoundary: React.FC<ErrorBoundaryProps> = ({ children }) => {
  const RouteErrorFallback: React.FC<{ error: Error; resetError: () => void }> = ({
    resetError
  }) => (
